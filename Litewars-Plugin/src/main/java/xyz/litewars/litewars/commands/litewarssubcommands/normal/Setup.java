...
public class Setup extends SubCommand {
    ...
    public boolean execute (CommandSender sender, Command command, String s, String[] strings) {
        ...
        if (world1 != null) {
            ...
            LitewarsRunningData.playerSetupArenaMap.put(player, new Arena(world1.getName(), config));
            LitewarsRunningData.lobbyManager.removePlayer(player);
            LitewarsRunningData.lobbyPlayers.remove(player);
